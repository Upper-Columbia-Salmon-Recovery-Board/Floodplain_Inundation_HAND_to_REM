...
top_height_ft_x = 30 # the top height (feet) to search to for elevation in cross section elevation profile
increment_ft = 0.1 # increments (in feet) to increase stage height to reach wetted area for the cross section elevation profile
number_of_cross_sectional_points = 1000 # number of cross-sectional points to calculate area
...
# ------------ Script to pull the wetted area based on flood discharge ----------
source(paste(script_path, 'FUNCTION_pull_wetted_area_from_discharge.R', sep="")) 

# ----------- Script to calculate flood stage height from wetted area based on elevation profile ---------
...
# ---------------------------------------------------------------------------------------------------- 
#    Info for each transect including HAND CatchID, .tif file path, flood discharge, transect lat/lon endpoints
# ---------------------------------------------------------------------------------------------------- 
